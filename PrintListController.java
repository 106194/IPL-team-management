...
public class PrintListController implements Initializable{
    @FXML
    Stage stage;
    @FXML
    Scene scene;
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        table.setItems(list);
        table.setOnMouseClicked(event->{Details(event);});
    }
    @FXML
    ...
    @FXML
    public void Details(MouseEvent e){
